...
To edit the Objective-C files, open `example/ios/VisionCameraFaceDetectorExample.xcworkspace` in XCode and find the source files at `Pods > Development Pods > vision-camera-face-detector`.
